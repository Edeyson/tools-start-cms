...
<dnn:DnnCssInclude Priority="15" ID="header2" runat="server" FilePath="assets/css/header--3.css" PathNameAlias="SkinPath" HtmlAttributesAsString="rel:stylesheet" />
...
<div class="body-page-notfound">
    <div class="header-container">
        <!--#include file="includes/_header/header_3.ascx"-->

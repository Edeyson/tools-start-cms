...
<dnn:DnnCssInclude Priority="15" ID="fontawesome" runat="server" FilePath="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.css" ForceProvider="DnnFormBottomProvider" HtmlAttributesAsString="rel:stylesheet" />
...
<dnn:DnnCssInclude Priority="15" ID="skin" runat="server" FilePath="assets/css/skin.css" PathNameAlias="SkinPath" HtmlAttributesAsString="rel:stylesheet" />
...
<script>
let browser=navigator.appName,ver=navigator.appVersion,thestart=parseFloat(ver.indexOf("MSIE"))+1,brow_ver=parseFloat(ver.substring(thestart+4,thestart+7));document.documentMode&&(window.location="/ie");
</script>
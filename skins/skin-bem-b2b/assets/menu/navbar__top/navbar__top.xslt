...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<nav class="_navbar _navbar--top" id="@id">
	...
	<xsl:template match="node">
		<li class="_navbar__item">
			<xsl:attribute name="class">_navbar__item _navbar__item--top 
					   ...
					   <xsl:choose>
							<xsl:when test="node">
								<div class="_navbar__container-link-submenu _navbar__container-link-submenu--top">
									<a class="_navbar__link _navbar__link--top" href="{@url}">
										<xsl:if test="@icon">
											<img src="{@icon}" />
										</xsl:if>
										<xsl:if test="@target">
									...
									<!-- subpageIFdesk -->
									<span id="sub-page" class="_navbar__btn-page-desk _navbar__btn-page _navbar__btn-page--top"><iconify-icon icon="uil:angle-down"></iconify-icon></span>
									</a>
									<!-- subpageIFmobile -->
									<span id="sub-page" class="_navbar__btn-page-mobile _navbar__btn-page _navbar__btn-page--top"><iconify-icon icon="uil:angle-down"></iconify-icon></span>
								</div>
							</xsl:when>
							<xsl:otherwise>
								<a class="_navbar__link _navbar__link--top" href="{@url}">
